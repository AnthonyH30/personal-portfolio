...
export default function About(){
    return(
        <AboutStyle>
            ...
            <p className="description">Em 2020 decidi transformar essa paixão em profissão, e desde então tenho me dedicado a aprender desenvolvimento web, tenho muito a aprender ainda, e isso me deixa ainda mais animado para continuar!</p>
